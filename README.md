...
The installer always writes output under the current working directory (`.claude`, `.gemini`, `.codex`), so run it from the directory you want to install into (usually `~` for user-global agent config).
